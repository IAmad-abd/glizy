                ...
                <div className="tw-flex tw-flex-1 tw-flex-col-reverse md:tw-flex-row tw-mx-auto tw-gap-8 tw-justify-between">
                  <div className="tw-flex tw-flex-col tw-gap-4 tw-flex-grow md:tw-max-w-[40%]">
                      ...
                      <div className="tw-flex tw-items-center tw-gap-2">
                        ...
                        >
                          <a
                            target="_blank"
                            rel="noopener noreferrer"
                                                                    href="https://discord.com/invite/glizzyroyale"
                          >
                            <img
                        ...
                        >
                          <a
                            target="_blank"
                            rel="noopener noreferrer"
                                                                    href="https://twitter.com/GlizzyRoyale"
                          >
                            <img
                    ...
                    <p className="tw-mb-4 tw-text-gray-light">
                                                        Glizzy Royale is a P2E Battle Royale with a 1v1
                                                        arena mode that is currently playable. The entire
                                                        game map is based on different Solana NFT
                                                        projects and the project’s long-term vision
                                                        involves integrating 3D versions of NFTs from
                                                        popular collections to be used in-game.
                    </p>
                    ...
                    <div className="tw-w-full">
                      <div className="tw-flex tw-flex-col tw-gap-1 tw-flex-grow 3xl:tw-hidden">
                        <div className="tw-flex tw-items-center tw-justify-between tw-text-[14px] tw-text-gray-5">
                          ...
                          <span>
                            <b className="tw-text-white-1">93%</b> (3720/4000)
                          </span>
                        </div>
                            ...
                            <div id="root" style={{ display: "flex" }}>
                              <main>
                                <div className="sc-dlfnuX bJgQKs">
                                  <button
                                    className="MuiButtonBase-root MuiButton-root MuiButton-contained sc-bdfBQB kKVOCU MuiButton-containedPrimary"
                                    tabIndex={0}
                                    type="button"
                                  >
                  ...
                  <div className="tw-flex tw-flex-1 tw-flex-col md:tw-flex-row tw-mx-auto tw-gap-32 tw-pb-20 tw-justify-between">
                    <div className="tw-flex tw-flex-col tw-gap-4 tw-flex-grow md:tw-w-[40%]">
                      ...
                      <div className="tw-flex tw-flex-wrap tw-gap-4">
                        ...
                        <a
                                                                href="https://the-stoned-frogs.gitbook.io/whitepaper/"
                          target="_blank"
                          rel="noreferrer noopener"
                          className="tw-border tw-border-solid tw-border-purple-1 tw-flex tw-items-center tw-gap-2 tw-w-fit tw-rounded-full tw-px-2.5 tw-py-1.5 tw-text-white-2"
                        >
                      ...
                      <div>
                        ...
                        <p className="tw-text-gray-light tw-mb-3 tw-text-[16] tx-line-[24]">
                                                                ...
                                                                Short-term, the project is focused on bringing
                                                                immediate utility with their 1v1s arena mode
                                                                where players will be able to:

                                                                Wager $GLIZZY in 1v1 matches
                                                                Mint NFT weapons and weapon skins with $GLIZZY
                                                                Enter tournaments with $GLIZZY for a chance to win
                                                                large $SOL prize pools
                                                                The 1v1s mode will evolve post-mint with new
                                                                maps, weapons, and unique abilities.

                                                                Medium

                                                                Hear us pitch on the Sovana Shark Tank! We
                                                                were one of the first projects to receive an
                                                                unanimous "mint" from all four judges. We begin
                                                                our pitch 42:00 minutes into the show.

                                                                Glizzy Royale Arena 1.1.3 Download (Windows
                                                                , US/Canada Server)
                        </p>
                      </div>
                    </div>
                    <div className="tw-flex tw-flex-col tw-gap-4 tw-flex-grow md:tw-w-[50%]">
                      ...
                      <div className="tw-p-4">
                        <div className="tw-p-4">
                          ...
                          <div className="tw-my-1">
                                                                    <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                        1️⃣ NFT Fusion - The Fusion Chamber Opens

                                                                        Our deflationary fusion mechanic goes live. All of the core fusion
                                                                        combinations are now available. See
                                                                        https://medium.com/@glizzyroyale/fusion-explained-5612326901d5
                                                                        for a more detailed overview of this unique system.
                          ...
                          <div className="tw-my-1">
                            <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                        2️⃣ Arena Season 0
                                                                        We are integrating the web 2.0 version of the 1v1s
                                                                        Arena with our discord, which will allow us to
                                                                        keep track of everyone's kills and victories.
                                                                        There will be a $SOL prize pool for holders who
                                                                        place highly on the leaderboards. Season 0 will last until
                                                                        the launch of the web 3.0 integrated arena.
                            </p>
                            <br />
                          </div>
                          ...
                          <div className="tw-my-1">
                            <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                        ...
                                                                        We will donate to charitywater.org, an organization
                                                                        that helps build wells in Africa that provide
                                                                        clean drinking water for thousands of
                                                                        water-insecure adults and children.
                            </p>
                            <br />
                          </div>
                           <div className="tw-my-1">
                          ...
                          <div className="tw-my-1">
                            <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                        ...
                                                                        You can now stake your NFT to passively earn $GLIZZY.
                            </p>
                            <br />
                          </div>
                                                                ...
                                                                <div className="tw-my-1">
                                                                    <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                        ...
                                                                        Unique abilities tied to NFT-based mech buns that will
                                                                        be mintable with $GLIZZY. Some ideas include jetpack-like
                                                                        flying and cooldown-based rocket jumps.

                                                                        Introduction of a 2v2s mode

                                                                        A brand new map balanced around new abilities and the
                                                                        2v2s gameplay

                                                                        After the conclusion of season 2, we will shift our focus
                                                                        to development of our core game, Glizzy Royale. However,
                                                                        we will continue to maintain and add updates to
                                                                        the arena to ensure gameplay remains interesting.
                                                                    </p>
                                                                    <br />
                                                                </div>
